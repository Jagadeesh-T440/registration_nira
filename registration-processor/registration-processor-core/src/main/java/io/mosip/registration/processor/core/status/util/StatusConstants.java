...
public final class StatusConstants {
	...
	public static final String CITIZENSHIP_VERIFICATION = RPR_REGISTRATION_PROCESSOR_PREFIX + "CV-";
	public static final String CITIZENSHIP_VERIFICATION_SUCCESS = CITIZENSHIP_VERIFICATION + SUCCESS;
	public static final String CITIZENSHIP_VERIFICATION_FAILED = CITIZENSHIP_VERIFICATION + FAILED;
}
